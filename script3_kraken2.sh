...
#SBATCH -o ../%u/output_script3_KRAKEN_%j.txt
#SBATCH -e ../%u/errors_script3_KRAKEN_%j.txt
...
INPUTDIR=/scratch/project_2005451/Nebir_Sad/extra/trimming/trim_output

OUTPUTDIR=/scratch/project_2005451/Nebir_Sad/kraken/kraken_results  
...
for f in $INPUTDIR/*_filtered_1P.fastq.gz  
do  
    echo "Processing $f"  
	...
	--output $OUTPUTDIR/"${prfx}".PE.kraken.out \
    	"${dir}"_filtered_1P.fastq.gz \
		"${dir}"_filtered_2P.fastq.gz
